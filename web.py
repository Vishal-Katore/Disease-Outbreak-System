...
st.set_page_config(page_title="Prediction of disease Outbreaks",
                   layout='wide',
                   page_icon=":doctor:")
diabetes_model=pickle.load(open(r"C:\Users\vtkat\.vscode\Intership\Predictions\training model\diabetes_model.sav","rb"))
heart_disease_model=pickle.load(open(r"C:\Users\vtkat\.vscode\Intership\Predictions\training model\heart_model.sav","rb"))
parkinsons_model=pickle.load(open(r"C:\Users\vtkat\.vscode\Intership\Predictions\training model\parkinsons_model.sav","rb"))
